		...
		<section>
			...
			<section>
				...
				<dl>
					...
					<dd>相手のデッキ枚数です。</dd>
					<dt>フィールド右上の数字(紫)</dt>
					<dd>相手のトラッシュにあるカードの枚数です。</dd>
					<dt>フィールド左下の数字(紫)</dt>
					<dd>自分のトラッシュにあるカードの枚数です。</dd>
					<dt>フィールド右下の数字(黄)</dt>
					<dd>自分のデッキ枚数です。</dd>
					<dt>フィールド上部の数字(赤)</dt>
					<dd>相手のライフです。</dd>
			...
			<section>
				...
				<dl>
					<dt>プレイ</dt>
					<dd>カードを手札から使うことです。</dd>
					<dt>トラッシュ</dt>
					<dd>使い終わったスペルカードと、退場になったユニットが置かれるところです。</dd>
					<dt>退場</dt>
					<dd>ユニットが戦闘で負けたり、カードの効果でパワーが0になったときに、そのユニットがトラッシュに送られることです。退場したときに効果を発揮するカードもあります。</dd>
					<dt>登場</dt>
					<dd>ユニットカードをプレイすることです。登場したときに効果を発揮するカードもあります。</dd>
				</dl>
			</section>
		</section>
		<footer>
